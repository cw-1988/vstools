...
export const Collada = {
  ...
  animation_clip: function (_geometry) {
    return [
  ...
  library_cameras: function (_root) {
    const cameras = '';
  ...
  library_effects: function (_root) {
