import type { AkaoChannel, AkaoOp, BinaryReader } from './types.js';
...
export class Akao {
  ...
  read() {
    ...
    const channels: AkaoChannel[] = (this.channels = []);
    ...
    channels.forEach(function (channel: AkaoChannel) {
    ...
    channels.forEach(function (channel: AkaoChannel) {
      ...
      while (true) {
        ...
        ops.push({ op, params } satisfies AkaoOp);
